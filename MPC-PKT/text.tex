...
% TODO Popsat tabulku, nebo alespoň uvést co jsou ty hvězdičky
...
% TODO menší směrovací tabulky, nepotřebuje NAT
...
% TODO Toto by šlo zjednodušit
% - Y0 a Y1 a X0 a X1 místo Y2 a X2
% vlevo: vstup/výstup a uvnitř stav
% vpravo: vstup a uvnitř uzel a výstup
% 1 na výstupu znamená dokončená detekce
